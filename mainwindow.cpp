...
:QMainWindow(parent)
{
	QTextCodec::setCodecForTr(QTextCodec::codecForName("UTF-8")); //设置字体，显示中文
	setWindowTitle(tr("贪食蛇游戏")); //标题 
	screen = new Screen(this);
	setCentralWidget(screen); //中央窗口为screen
	createMenu();
}
...
{
	QMessageBox::information(this, tr("关于贪食蛇游戏"),tr("Snake GAME!"));
}
